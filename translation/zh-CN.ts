...
export default {
  ...
  tip_infection_intensity:
    '您是否想选择强传染(强互惠)的协议？当您选择强传染(强互惠)许可证时，任何使用、修改或分发您的代码的人都必须遵循相同的许可证要求。这意味着他们必须提供源代码，并将其代码以相同的许可证发布。这样，您的代码的开放性将被保护，并且任何人都可以获得您的代码的源代码，以便进行学习、改进和共享。强传染性许可证确保了对整个项目的开放性和共享性，促进了开源社区的合作和创新。但是，选择强传染性许可证可能会对某些开发者或组织造成限制。',
