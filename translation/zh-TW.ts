export default {
  ...
  our_community_structure_overview: '組織架構全景圖',
  our_council: '理事會',
  our_executive_committee: '執行委員會',
  our_project_committee: '項目委員會',
  our_advisory_committee: '顧問委員會',
  our_legal_advisory_committee: '法律咨詢委員會',
  our_members: '正式成員',
  our_blogs: '開源文庫',
