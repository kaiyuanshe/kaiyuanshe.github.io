...
export const MainRoutes = (): Link[] => [
  {
    ...
    subs: [
      ...
      { title: t('honor_COSCon'), path: '/community/honor/COSCon' },
      { title: t('honor_star'), path: '/community/honor/star' },
      { title: t('honor_community_cooperation'), path: '/community/honor/community-cooperation' },
    ],
  },
  {
