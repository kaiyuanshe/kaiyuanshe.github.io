...
import { OrganizationModel, OrganizationStatistic } from '../../models/Community/Organization';
...
@observer
export class OpenCollaborationMap extends ObservedComponent<
  OpenCollaborationMapProps,
  typeof i18n
> {
    ...
    return (
      <div>
        <Nav
          ...
          activeKey={tabKey}
          onSelect={key => key && (this.tabKey = key as OpenCollaborationMap['tabKey'])}
        >
          <Nav.Item>
