...
import { OrganizationStatistic, sortStatistic } from '../../models/Community/Organization';

const OrganizationCharts: FC<OrganizationStatistic> = observer(({ type, tag, year, city }) => {
